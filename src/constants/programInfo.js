import logo from "../images/logo_evolve.png" // add school logo to images folder and import here
...
export const schoolName = "Evolve Academy"

export const schoolURL = 'https://www.evolvesecurity.io/' // update with url of school's website

export const skfURL = 'https://evolveacademy.skills.fund/' // update with Skills Fund url

export const headline = "Learn Cyber Security at Evolve Academy" // update headline as appropriate

export const leadContent = {
    header: "Your last step on the path toward changing your career",
    paragraph: `${schoolName} designs its programs to provide students a foundation for a career in Cyber Security. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const netlifyFormName = 'evolveacademy_contact'

export const GATracking = 'UA-68312423-1'

export const hubspotFormId = "05f3bea1-3132-4d51-aec9-448233ab78d0" // create Hubspot form, get form id after publishing

export const selectAProgram = "select_a_evolveacademy_program" // update school name to match form field on Hubspot, *** change to "program_name" if only one program ***"
...
export const programLoanInfo = [ // update with program names and corresponding loan URLs with market segment code from Master Loan Parameters
    {
        name: "Bootcamp Pro",
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKEV17",
    ...
    {
        name: "Bootcamp Remote",
        url: "https://sf.privateloan.studentloan.org/external/LoanApplication.do?lenderCode=SKEVONL17",
        loanInfo: { // match loanInfo in first metro below
            maxLoanAmt: 10500,
            loanTerm36: true,
            loanTerm60: true,
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to $12,500 for Bootcamp Pro tuition and up to $3,000 for cost of living, or up to $10,500 for Bootcamp Remote tuition."
