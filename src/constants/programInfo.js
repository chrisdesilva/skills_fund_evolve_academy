...
export const leadContent = {
  ...
  paragraph: `${schoolName} designs its programs to provide students a foundation for a career in Cyber Security. ${schoolName} partners with Skills Fund to offer tuition${
