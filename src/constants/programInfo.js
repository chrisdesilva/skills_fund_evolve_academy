...
export const leadContent = {
	...
	paragraph: `${schoolName} designs its programs to provide students a foundation for a career in Cyber Security. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
...
export const programLoanInfo = [
	...
	},
	{
		...
		url: 'https://my.skills.fund/application?lenderCode=SKEVONL17',
		loanInfo: {
			// match loanInfo in first metro below
			maxLoanAmt: 10500,
			loanTerm36: true,
